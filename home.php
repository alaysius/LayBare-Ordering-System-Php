...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Products<a href="rooms-tariff.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Services Packages<a href="gallery.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Branches<a href="gallery.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
    </div>
</div>
</div>
